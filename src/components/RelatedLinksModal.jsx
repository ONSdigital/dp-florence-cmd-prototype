...
export default class RelatedLinksModal extends Component {
    constructor(props) {
        super(props)
        ...
        return (
            <div>
                ...
                <div className="modal__body">
                    ...
                    <input className="input input__text margin-bottom--1" onChange={this.handleUriChange} value={this.state.uri}/>

                    <label className="form__label">Title</label>
                    <input className="input input__text margin-bottom--1" onChange={this.handleValueChange} value={this.state.value}/>
                </div>
